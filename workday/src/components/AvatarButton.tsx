...
const AvatarButton = ({text, onClick} : IProps) => {
  return (
    <Box sx={{cursor : 'pointer'}} borderRadius={1} columnGap={2} display='flex' justifyContent='center' alignItems='center' bgcolor={'primary.contrastText'} width='100%' height={50} onClick = {onClick}>
